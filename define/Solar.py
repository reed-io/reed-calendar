...
class Solar:
    ...
    def __init__(self, year, month, day, hour, minute, second):
        ...
        self.__calendar = DateTimeUtil.fromYmdHms(year, month, day, hour, minute, second)
    ...
    def getLunar(self):
        ...
        :return: 农历
        """
        from define.Lunar import Lunar
    ...
    def next(self, days, only_work_day=False):
        ...
        c = DateTimeUtil.fromYmdHms(self.__year, self.__month, self.__day, self.__hour, self.__minute, self.__second)
        if days != 0:
